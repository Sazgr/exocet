...
struct Move_order {
    ...
    void caphist_update(Move move, int change, bool success) {
    ...
    void history_update(Move move, int change, bool success) {
    ...
    void butterfly_update(Move move, int change, bool success) {
    ...
    void continuation_update(Move previous, Move current, int change, bool success) {
